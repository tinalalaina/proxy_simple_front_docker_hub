...
Ce projet inclut un workflow GitHub Actions: `.github/workflows/docker-publish.yml`.
...
### Image publiée
- Nom d'image: `${DOCKERHUB_USERNAME}/simple_proxi_pass_fr_doc`
- Tags générés automatiquement: `main`, tag git (`v1.0.0`), et SHA commit.
